...
**** Pandas
#+begin_src python :session localhost :results output :tangle ./Exercises/Python-mod3/Execises/libraries-pandas.py
import pandas as pd
...
#+RESULTS:
**** NLTK
#+begin_src python :session localhost :results output :tangle  ./Exercises/Python-mod3/Execises/libraries-nltk.py
import nltk

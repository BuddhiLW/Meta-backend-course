...
#+begin_src python :session localhost :results output :eval no :tangle ./Exercises/Python-mod3/imports.py
import sys
...
**** Pandas
#+begin_src python :session localhost :results output :eval no :tangle ./Exercises/Python-mod3/Execises/libraries-pandas.py
import pandas as pd
...
#+RESULTS:
**** NLTK
#+begin_src python :session localhost :results output :eval no :tangle  ./Exercises/Python-mod3/Execises/libraries-nltk.py
import nltk

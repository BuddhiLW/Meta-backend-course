...
- [[#databases][Databases]]
  ...
  - [[#week-3---sql-arithmetic-operators][Week 3 - SQL Arithmetic Operators]]
...
| Field     | Type        | Null | Key | Default | Extra |
+-----------+-------------+------+-----+---------+-------+
| funcID    | tinyint(4)  | YES  |     | NULL    |       |
| age       | tinyint(4)  | YES  |     | NULL    |       |
| work_time | tinyint(4)  | YES  |     | NULL    |       |
| whentook  | date        | YES  |     | NULL    |       |
...
MariaDB [mydb]> show columns from w2e4;
+-----------+-------------+------+-----+-----------+-------+
| Field     | Type        | Null | Key | Default   | Extra |
+-----------+-------------+------+-----+-----------+-------+
| funcID    | tinyint(4)  | YES  |     | NULL      |       |
...
#+RESULTS:
: +--------+------+-----------+------------+--------------+
: | funcID | age  | work_time | whentook   | status       |
: +--------+------+-----------+------------+--------------+
: |      1 |   27 |         3 | 2022-08-24 | Recepcionist |
: |      2 |   30 |         2 | 2022-08-24 | Collector    |
: +--------+------+-----------+------------+--------------+
: 2 rows in set (0,000 sec)
*** Select and insert, between tables
...
#+begin_example
+----------+-------+--------+--------+----------+
| playerId | name  | height | weight | avgSpeed |
+----------+-------+--------+--------+----------+
|        1 | João  |   2    |     80 |       10 |
|        2 | Mario |   2    |     86 |        8 |
+----------+-------+--------+--------+----------+
...
DONE: See =Update and Delete= (next section).
*** Update and Delete
:LOGBOOK:
CLOCK: [2022-08-25 qui 17:18]--[2022-08-27 sáb 10:20] => 41:02
:END:
#+begin_src sql
UPDATE soccer
SET height = '1.72'
...
#+begin_example
+----------+-------+--------+--------+----------+----------+
| playerId | name  | height | weight | avgSpeed | position |
+----------+-------+--------+--------+----------+----------+
|        1 | João  |   1.72 |     80 |       10 | runner   |
|        2 | Mario |   1.85 |     86 |        8 | runner   |
+----------+-------+--------+--------+----------+----------+
2 rows in set (0,000 sec)
#+end_example
...
- Types of data will have different ascending and descending sorting types
